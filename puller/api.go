...
func (m *Indexer) ChainByHeight(ctx context.Context, height int64) (*models.Chain, error) {
	c := &models.Chain{}
	if err := m.statedb.Where("height = ?", height).First(c).Error; err != nil {
		return nil, err
	}
	return c, nil
}

func (m *Indexer) SupplyByHeight(ctx context.Context, height int64) (*models.Supply, error) {
	s := &models.Supply{}
	err := m.statedb.Where("height = ?", height).First(s).Error
	return s, err
}

// func (m *Indexer) SupplyByTime(ctx context.Context, t time.Time) (*models.Supply, error) {
...
func (m *Indexer) BlockByID(ctx context.Context, id uint64) (*models.Block, error) {
	b := &models.Block{}
	err := m.statedb.Where("row_id = ?", id).First(b).Error
	if err != nil {
		return nil, err
	}
...
// func (m *Indexer) BlockByParentId(ctx context.Context, id uint64) (*models.Block, error) {
...
func (m *Indexer) BlockHashByHeight(ctx context.Context, height int64) (chain.BlockHash, error) {
	b := &models.Block{}
	err := m.statedb.Select("row_id, hash").Where("height = ? and is_orphan = ?", height, false).First(b).Error
	if err != nil {
...
func (m *Indexer) BlockHashById(ctx context.Context, id uint64) (chain.BlockHash, error) {
	b := &models.Block{}
	err := m.statedb.Select("hash").Where("row_id = ?", id).First(b).Error
	if err != nil {
		return chain.BlockHash{}, err
	}
...
func (m *Indexer) BlockByHeight(ctx context.Context, height int64) (*models.Block, error) {
	b := &models.Block{}
	err := m.statedb.Where("height = ? and is_orphan = ?", height, false).First(b).Error
...
func (m *Indexer) BlockByHash(ctx context.Context, h chain.BlockHash) (*models.Block, error) {
	if !h.IsValid() {
...
// func (m *Indexer) LookupBlock(ctx context.Context, blockIdent string) (*models.Block, error) {
// 	var (
// 		b   *model.Block
// 		err error
// 	)
...
// func (m *Indexer) LookupLastBakedBlock(ctx context.Context, a *model.Account) (*models.Block, error) {
// 	if a.BlocksBaked == 0 {
// 		return nil, index.ErrNoBlockEntry
// 	}
// 	blocks, err := m.Table(index.BlockTableKey)
...
// func (m *Indexer) LookupLastEndorsedBlock(ctx context.Context, a *model.Account) (*models.Block, error) {
// 	if a.BlocksBaked == 0 {
// 		return nil, index.ErrNoBlockEntry
// 	}
...
// func (m *Indexer) LookupNextRight(ctx context.Context, a *model.Account, height int64, typ chain.RightType, prio int64) (*models.Right, error) {
...
// func (m *Indexer) ListBlockEndorsingRights(ctx context.Context, height int64) ([]models.Right, error) {
// 	rights, err := m.Table(index.RightsTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
func (m *Indexer) LookupContractId(ctx context.Context, id models.AccountID) (*models.Contract, error) {
	cc := &models.Contract{}
	err := m.statedb.Where("account_id = ?", id.Value()).First(cc).Error
	if err == gorm.ErrRecordNotFound {
		// try account lookup and stitch manager.tz for pre-babylon KT1's
...
func (m *Indexer) LookupAccountId(ctx context.Context, id models.AccountID) (*models.Account, error) {
	a := &models.Account{}
	err := m.statedb.Where("row_id = ?", id.Value()).First(a).Error
	if err == gorm.ErrRecordNotFound {
		return nil, index.ErrNoAccountEntry
	}
...
// func (m *Indexer) LookupAccountIds(ctx context.Context, ids []uint64) ([]*models.Account, error) {
...
func (m *Indexer) ListAllDelegates(ctx context.Context) ([]*models.Account, error) {
	var accs []*models.Account
	err := m.statedb.Where("is_delegate = ?", true).Find(&accs).Error
	if err != nil {
		return nil, err
	}
...
// func (m *Indexer) ListActiveDelegates(ctx context.Context) ([]*models.Account, error) {
// 	table, err := m.Table(index.AccountTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) ListManaged(ctx context.Context, id model.AccountID, offset, limit uint) ([]*models.Account, error) {
// 	table, err := m.Table(index.AccountTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) LookupOp(ctx context.Context, ophash string) ([]*models.Op, error) {
...
// func (m *Indexer) FindActivatedAccount(ctx context.Context, addr chain.Address) (*models.Account, error) {
// 	table, err := m.Table(index.OpTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) ListBlockOps(ctx context.Context, height int64, typ chain.OpType, offset, limit uint) ([]*models.Op, error) {
// 	table, err := m.Table(index.OpTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) ListAccountOps(ctx context.Context, accId model.AccountID, typ chain.OpType, since, until int64, offset, limit uint, order pack.OrderType) ([]*models.Op, error) {
// 	table, err := m.Table(index.OpTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) ListContractCalls(ctx context.Context, accId model.AccountID, since, until int64, offset, limit uint, order pack.OrderType) ([]*models.Op, error) {
// 	table, err := m.Table(index.OpTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) FindLastCall(ctx context.Context, acc model.AccountID, height int64) (*models.Op, error) {
...
// func (m *Indexer) ListContractBigMapIds(ctx context.Context, acc models.AccountID) ([]int64, error) {
...
// func (m *Indexer) ElectionByHeight(ctx context.Context, height int64) (*models.Election, error) {
...
// func (m *Indexer) ElectionById(ctx context.Context, eid model.ElectionID) (*models.Election, error) {
// 	table, err := m.Table(index.ElectionTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) VotesByElection(ctx context.Context, eid model.ElectionID) ([]*models.Vote, error) {
...
// func (m *Indexer) ProposalsByElection(ctx context.Context, eid model.ElectionID) ([]*models.Proposal, error) {
...
// func (m *Indexer) LookupProposal(ctx context.Context, proto chain.ProtocolHash) (*models.Proposal, error) {
// 	if !proto.IsValid() {
// 		return nil, ErrInvalidHash
// 	}
//
...
// func (m *Indexer) LookupProposalIds(ctx context.Context, ids []uint64) ([]*models.Proposal, error) {
// 	table, err := m.Table(index.ProposalTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) ListAccountBallots(ctx context.Context, accId model.AccountID, offset, limit uint) ([]*models.Ballot, error) {
...
// func (m *Indexer) LookupSnapshot(ctx context.Context, accId model.AccountID, cycle, idx int64) (*models.Snapshot, error) {
...
func (m *Indexer) LookupBigmap(ctx context.Context, id int64, withLast bool) (*models.BigMapItem, *models.BigMapItem, error) {
	alloc := &models.BigMapItem{}
	err := m.statedb.Where("bigmap_id = ? and action = ?", id, micheline.BigMapDiffActionAlloc).First(alloc).Error
	if err == gorm.ErrRecordNotFound {
	...
	err = m.statedb.Where("bigmap_id = ?", id).Last(last).Error

	return alloc, last, err
}

// func (m *Indexer) ListBigMapKeys(ctx context.Context, id, height int64, keyhash chain.ExprHash, key []byte, offset, limit uint) ([]*models.BigMapItem, error) {
// 	table, err := m.Table(index.BigMapTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (m *Indexer) ListBigMapUpdates(ctx context.Context, id, minHeight, maxHeight int64, keyhash chain.ExprHash, key []byte, offset, limit uint) ([]*models.BigMapItem, error) {
// 	table, err := m.Table(index.BigMapTableKey)
// 	if err != nil {
// 		return nil, err
// 	}
